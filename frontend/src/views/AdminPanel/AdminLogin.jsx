    ...
    if (response.credential) {
      try {
        ...
        const existingUserResponse = await fetch(
          `${deployURLs.backendURL}/api/googleAddUser`,
          {
            method: "POST",
            headers: {
        ...
        navigate("/home", {
          state: { user: localStorage.user, token: localStorage.token },
        });
        ...
        <div className="form-container sign-up">
          <form>
            ...
            <p style={{ textAlign: "justify" }}>
              FeedTrack is a platform utilized in bank branches to collect
              feedback from customers after service transactions. This feedback
              helps administrators to analyze and improve customer experience.
              Additionally, FeedTrack enables running various campaigns to
              gather diverse responses and insights for further enhancements.
            </p>
            <p style={{ textAlign: "justify" }}>
              Join us on our journey to revolutionize customer feedback in
              banking! 💼📊
            </p>
          </form>
        </div>
        ...
        <div className="toggle-container">
          <div className="toggle">
            ...
            <div className="toggle-panel toggle-right">
              <h1>Hello there!</h1>
              <p>
                Curious to learn more about us? Let's dive in and discover what
                makes us unique! 💡🔍
              </p>
